...
const NotFound = () => {
    return (
        <section className="mx-auto w-full max-w-7xl min-h-screen flex justify-center items-center px-2 md:px-4">
            <div className="mx-auto my-12 flex max-w-6xl flex-col px-2 md:my-24 lg:my-32 lg:flex-row lg:items-center gap-10">
                <div className="lg:w-1/2">
                    <p className="text-sm lg:text-xl font-semibold text-black">404 error</p>
                    <h1 className="mt-3 text-2xl font-semibold text-gray-800 md:text-3xl lg:text-5xl">
